...
__decorate([
    ...
    __metadata("design:type", String)
], CreateTripDto.prototype, "dateRange", void 0);
__decorate([
    swagger_1.ApiProperty({ required: true }),
    class_validator_1.IsNotEmpty({
    ...
    __metadata("design:type", String)
], CreateTripDto.prototype, "categories", void 0);
__decorate([
    swagger_1.ApiProperty({ required: true }),
    class_validator_1.IsNotEmpty({
    ...
    __metadata("design:type", String)
], CreateTripDto.prototype, "allEvents", void 0);
__decorate([
    swagger_1.ApiProperty({ required: true }),
    class_validator_1.IsNotEmpty({
    ...
    __metadata("design:type", String)
], CreateTripDto.prototype, "calendarEvents", void 0);
__decorate([
    swagger_1.ApiProperty({ required: true }),
    class_validator_1.IsNotEmpty({
    ...
    __metadata("design:type", String)
], CreateTripDto.prototype, "sidebarEvents", void 0);
__decorate([
    swagger_1.ApiProperty({ required: true }),
    class_validator_1.IsNotEmpty({
    ...
    class_validator_1.IsString(),
    __metadata("design:type", String)
], CreateTripDto.prototype, "calendarLocale", void 0);
