...
export class TripadvisorService implements BaseSourceService{
    ...
    format(destination: string, json: Record<string, any>){
        ...
        return {
            ...
            videos: [],
            source: this.source,
            more_info: moreInfoLink ? `https://www.tripadvisor.com${moreInfoLink}` : undefined,
            duration,
            category,
            //
            icon: undefined, // ?
    ...
    async search({ destination, page = 1 }: SearchDto, user: User): Promise<SearchResults> {
        ...
        const config = {
            headers: {
                ...
                'origin': 'https://www.tripadvisor.com',
                'priority': 'u=1, i',
                'referer': 'https://www.tripadvisor.com/Attractions-g187460-Activities-oa0-Ibiza_Balearic_Islands.html',
                'sec-ch-device-memory': '8',
                'sec-ch-ua': '"Not/A)Brand";v="8", "Chromium";v="126", "Google Chrome";v="126"',
                'sec-ch-ua-arch': '"x86"',
                'sec-ch-ua-full-version-list': '"Not/A)Brand";v="8.0.0.0", "Chromium";v="126.0.6478.127", "Google Chrome";v="126.0.6478.127"',
                        ...
                        "request": [
                            {
                                ...
                                "opaqueIds": [],
                                "origin": "https://www.tripadvisor.com",
                                "referrer": "https://www.tripadvisor.com/Attractions-g187460-Activities-c42-Ibiza_Balearic_Islands.html",
                                "toPage": "AttractionsFusion",
                                "toParams": [
                                    {
                                        "key": "geoId",
